...
export default function MonthlyEarnings({ earnings, percentageChange }: MonthlyEarningsProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-pink-100 to-purple-100 rounded-2xl p-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="h-16 bg-white/50 rounded-lg flex items-end justify-between px-2 py-2">
          {Array.from({ length: 12 }).map((_, index) => (
            <div
              key={index}
              className="bg-gradient-to-t from-purple-400 to-purple-300 rounded-sm"
              style={{
