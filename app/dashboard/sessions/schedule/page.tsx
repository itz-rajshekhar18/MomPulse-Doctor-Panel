...
const UPCOMING_SCHEDULE = [
  { day: 'WED', date: '14', title: 'Newborn Care Q&A', time: '09:00 – 10:00 AM' },
  { day: 'THU', date: '15', title: 'Staff Meeting', time: '11:30 – 12:30 PM' },
];
                    ...
                    {UPCOMING_SCHEDULE.map((item) => (
                      <div key={item.date} className="flex items-center gap-3">
                        <div className="text-center w-10 flex-shrink-0">
                          <p className="text-xs text-gray-400 uppercase">{item.day}</p>
                          <p className="text-lg font-bold leading-none">{item.date}</p>
                        </div>
